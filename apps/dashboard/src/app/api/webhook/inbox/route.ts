...
import { getAllowedAttachments } from "@vision_dashboard/documents";
import { LogEvents } from "@vision_dashboard/events/events";
import { setupAnalytics } from "@vision_dashboard/events/server";
import { getInboxIdFromEmail, inboxWebhookPostSchema } from "@vision_dashboard/inbox";
import type { ProcessAttachmentPayload } from "@vision_dashboard/jobs/schema";
import { createClient } from "@vision_dashboard/supabase/server";
import { getExtensionFromMimeType } from "@vision_dashboard/utils";
...
const FORWARD_FROM_EMAIL = "inbox@vision_dashboard.ai";
