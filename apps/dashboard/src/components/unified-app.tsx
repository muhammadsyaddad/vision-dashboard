...
import type { UnifiedApp } from "@vision_dashboard/app-store/types";
...
import { Sheet, SheetContent, SheetHeader } from "@vision_dashboard/ui/sheet";
          ...
          <SheetHeader>
            ...
            <div className="mt-4">
              ...
              <div className="absolute bottom-4 pt-8 border-t border-border">
                ...
                <a
                  href="mailto:support@vision_dashboard.dev"
