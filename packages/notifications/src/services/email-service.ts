...
import { shouldSendNotification } from "@vision_dashboard/db/queries";
import InvoiceEmail from "@vision_dashboard/email/emails/invoice";
import InvoiceOverdueEmail from "@vision_dashboard/email/emails/invoice-overdue";
import InvoicePaidEmail from "@vision_dashboard/email/emails/invoice-paid";
import InvoiceReminderEmail from "@vision_dashboard/email/emails/invoice-reminder";
import TransactionsEmail from "@vision_dashboard/email/emails/transactions";
...
export class EmailService {
  ...
  #buildEmailPayload(email: EmailInput): CreateEmailOptions {
    ...
    const payload: CreateEmailOptions = {
      from: email.from || "Midday <middaybot@vision_dashboard.ai>",
      to: recipients,
