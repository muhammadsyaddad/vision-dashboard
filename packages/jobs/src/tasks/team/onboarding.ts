...
import { GetStartedEmail } from "@vision_dashboard/email/emails/get-started";
import { TrialEndedEmail } from "@vision_dashboard/email/emails/trial-ended";
import { TrialExpiringEmail } from "@vision_dashboard/email/emails/trial-expiring";
import { WelcomeEmail } from "@vision_dashboard/email/emails/welcome";
...
export const onboardTeam = schemaTask({
  ...
  run: async ({ userId }) => {
    ...
    await resend.emails.send({
      ...
      from: "Pontus from Midday <pontus@vision_dashboard.ai>",
      html: render(
        WelcomeEmail({
